...
//330359/1494326/2.50/6/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TPS22918DBVR" (originalName "TPS22918DBVR")
	...
	(compDef "TPS22918DBVR" (originalName "TPS22918DBVR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "3" (pinName "ON") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "VOUT") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "QOD") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "CT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPS22918DBVR"))
		...
		(attr "Manufacturer_Part_Number" "TPS22918DBVR")
		(attr "Mouser Part Number" "595-TPS22918DBVR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TPS22918DBVR?qs=f4l5qYp%2Fy%252B5F7w5ZAgmi7A%3D%3D")
		(attr "Arrow Part Number" "TPS22918DBVR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/tps22918dbvr/texas-instruments?utm_currency=USD&region=nac")
		(attr "Description" "5.5V, 2A, 52m load switch with adjustable rise time and adjustable quick output discharge")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/TPS22918")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "TPS22918DBVR.stp")
