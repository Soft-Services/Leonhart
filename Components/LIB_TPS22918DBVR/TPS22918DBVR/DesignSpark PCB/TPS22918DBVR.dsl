...
(library Library_1
	...
	(compDef "TPS22918DBVR" (originalName "TPS22918DBVR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "ON") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "VOUT") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "QOD") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "CT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.ti.com/lit/gpn/TPS22918")
		(attr "Height" "1.45 mm")
	)
