...
//241175/1494326/2.50/6/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TPD3S014DBVR" (originalName "TPD3S014DBVR")
	...
	(compDef "TPD3S014DBVR" (originalName "TPD3S014DBVR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPD3S014DBVR"))
		...
		(attr "Manufacturer_Part_Number" "TPD3S014DBVR")
		(attr "Mouser Part Number" "595-TPD3S014DBVR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TPD3S014DBVR?qs=1CfNGUMoiQ%252BDmiZShdlX0g%3D%3D")
		(attr "Arrow Part Number" "TPD3S014DBVR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/tpd3s014dbvr/texas-instruments?region=nac")
		(attr "Description" "Current Limit Load Sw & TVS 0.5A SOT23-6 Texas Instruments TPD3S014DBVR Load Switch IC, Current Limit Switch, 4.5  5.5V, 6-Pin, SOT-23")
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/tpd3s044.pdf")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "TPD3S014DBVR.stp")
