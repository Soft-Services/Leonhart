...
//1103088/1494326/2.50/7/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TVS0500DRVR" (originalName "TVS0500DRVR")
	...
	(compDef "TVS0500DRVR" (originalName "TVS0500DRVR") (compHeader (numPins 7) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "7" (pinName "GND_4") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "IN_3") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "IN_2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "IN_1") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TVS0500DRVR"))
		...
		(attr "Manufacturer_Part_Number" "TVS0500DRVR")
		(attr "Mouser Part Number" "595-TVS0500DRVR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TVS0500DRVR?qs=W0yvOO0ixfE%252BATlQ17YkMw%3D%3D")
		(attr "Arrow Part Number" "TVS0500DRVR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/tvs0500drvr/texas-instruments?region=europe")
		(attr "Description" "5V Flat-Clamp Surge Protection Device")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/tvs0500")
		(attr "<Component Height>" "0.8")
		(attr "<STEP Filename>" "TVS0500DRVR.stp")
