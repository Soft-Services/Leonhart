...
(library Library_1
	...
	(compDef "TVS0500DRVR" (originalName "TVS0500DRVR") (compHeader (numPins 7) (numParts 1) (refDesPrefix IC)
		...
		(compPin "7" (pinName "GND_4") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "IN_3") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "IN_2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "IN_1") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.ti.com/lit/gpn/tvs0500")
		(attr "Height" "0.8 mm")
	)
